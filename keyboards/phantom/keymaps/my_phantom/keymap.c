...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT_tkl_ansi_plus_five(
        ...
        _______, KC_WH_U, KC_UP,   KC_WH_D, _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_END,  _______,      KC_7,    KC_8,    KC_9,    \
        _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, _______, _______, _______, KC_PGUP, KC_PGDN,          _______,      KC_4,    KC_5,    KC_6,    \
