...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    LAYOUT_60_ansi(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            KC_SPC,                             KC_CAPS, MO(2),   KC_APP,  KC_RCTL),

    LAYOUT_60_ansi(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,
        _______, KC_WH_U, KC_UP,   KC_WH_D, _______, _______, _______, _______, _______, _______, KC_PAUS, KC_HOME, KC_END,  KC_PSCR,  
